...
def generate_report(
    ...
    src_flags = [
        ...
        ("src_healthy_reproductive", "Healthy reproductive, privileged (expected for CTAs)"),
        ("src_healthy_reproductive_female", "Healthy female-reproductive (sex-stratified)"),
        ("src_healthy_reproductive_male", "Healthy male-reproductive (sex-stratified)"),
